...
export const LLM_MODELS: LlmModelEntry[] = [
  ...
  { id: 'gemini-3.1-pro-preview', name: 'Gemini 3.1 Pro',   provider: 'gemini',    category: 'thinking' },
  { id: 'gemini-3.1-flash-lite', name: 'Gemini 3.1 Flash Lite', provider: 'gemini', category: 'fast' },
  { id: 'gemini-3-pro-preview', name: 'Gemini 3 Pro',       provider: 'gemini',    category: 'thinking' },
