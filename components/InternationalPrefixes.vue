...
// Lista esaustiva di prefissi internazionali per tutte le principali nazioni
const prefixes = [
  ...
  { name: 'Belgio', dial_code: '+32', code: 'BE', emoji: '🇧🇪' },
  { name: 'Paesi Bassi (Olanda)', dial_code: '+31', code: 'NL', emoji: '🇳🇱' },
  { name: 'Portogallo', dial_code: '+351', code: 'PT', emoji: '🇵🇹' },
  { name: 'Grecia', dial_code: '+30', code: 'GR', emoji: '🇬🇷' },
  { name: 'Polonia', dial_code: '+48', code: 'PL', emoji: '🇵🇱' },
  { name: 'Svezia', dial_code: '+46', code: 'SE', emoji: '🇸🇪' },
  { name: 'Norvegia', dial_code: '+47', code: 'NO', emoji: '🇳🇴' },
  { name: 'Danimarca', dial_code: '+45', code: 'DK', emoji: '🇩🇰' },
  { name: 'Finlandia', dial_code: '+358', code: 'FI', emoji: '🇫🇮' },
  { name: 'Irlanda', dial_code: '+353', code: 'IE', emoji: '🇮🇪' },
  { name: 'Repubblica Ceca', dial_code: '+420', code: 'CZ', emoji: '🇨🇿' },
  { name: 'Ungheria', dial_code: '+36', code: 'HU', emoji: '🇭🇺' },
  { name: 'Romania', dial_code: '+40', code: 'RO', emoji: '🇷🇴' },
  { name: 'Croazia', dial_code: '+385', code: 'HR', emoji: '🇭🇷' },
  ...
  { name: 'Nuova Zelanda', dial_code: '+64', code: 'NZ', emoji: '🇳🇿' },
  { name: 'Canada', dial_code: '+1', code: 'CA', emoji: '🇨🇦' },
  { name: 'Sudafrica', dial_code: '+27', code: 'ZA', emoji: '🇿🇦' },
  { name: 'Egitto', dial_code: '+20', code: 'EG', emoji: '🇪🇬' },
  { name: 'Marocco', dial_code: '+212', code: 'MA', emoji: '🇲🇦' },
  { name: 'Turchia', dial_code: '+90', code: 'TR', emoji: '🇹🇷' },
  { name: 'Emirati Arabi Uniti', dial_code: '+971', code: 'AE', emoji: '🇦🇪' },
  { name: 'Arabia Saudita', dial_code: '+966', code: 'SA', emoji: '🇸🇦' },
  { name: 'Israele', dial_code: '+972', code: 'IL', emoji: '🇮🇱' },
